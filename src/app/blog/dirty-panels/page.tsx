...
const relatedPosts = [
  {
    slug: "nz-weather-and-solar-output",
  ...
  {
    slug: "cleaning-frequency-nz",
    title: "How often should you clean your panels in NZ? It depends where you live",
  ...
  {
    slug: "understanding-your-output-gap",
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-2xl border border-white/8 overflow-hidden">
            ...
            {[
              ...
              <div key={row.loc} className="grid grid-cols-3 border-b border-white/8 last:border-b-0">
                <div className="px-4 py-4 text-sm text-white">{row.loc}</div>
                ...
                <div className="px-4 py-4 text-xs text-gray-600 leading-relaxed">{row.risk}</div>
              </div>
            ))}
          </div>
        </div>
